...
import { Core } from "@solarity/zkit";
...
import { processPoseidonDecryption, processPoseidonEncryption } from "./posidon";
...
export const privateMint = async (
    ...
    const circuit = await Core.getCircuit("MintCircuit");
...
export const privateBurn = async (
    ...
    const circuit = await Core.getCircuit("BurnCircuit");
...
export const privateTransfer = async (
    ...
    const circuit = await Core.getCircuit("TransferCircuit");
...
export const withdraw = async (
    ...
    const circuit = await Core.getCircuit("WithdrawCircuit");
