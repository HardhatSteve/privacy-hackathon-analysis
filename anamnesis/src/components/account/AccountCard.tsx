  ...
  return (
    <div
      className={`group relative cursor-pointer overflow-hidden rounded-2xl border-2 transition-all duration-300 ${
        isActive
          ? "shadow-primary-glow-lg scale-[1.02] border-transparent bg-gradient-to-br from-indigo-50 to-purple-50/30"
    ...
    >
      {isActive && (
        <div className="absolute top-0 left-0 h-full w-1 bg-gradient-to-b from-indigo-600 to-purple-600" />
      )}
            ...
            <div className="min-w-0 flex-1 space-y-1.5">
              ...
              <div className="flex items-center gap-2 font-mono text-[10px] text-slate-500 sm:text-xs">
                ...
                <button
                  ...
                  className="shrink-0 cursor-pointer p-1 text-slate-400 transition-colors hover:text-indigo-600"
                  title={t("common.copy")}
                >
