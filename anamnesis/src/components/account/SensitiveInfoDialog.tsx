  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="top-4 flex max-h-[calc(100vh-2rem)] max-w-2xl translate-y-0 flex-col sm:top-[50%] sm:translate-y-[-50%]">
            ...
            <div className="space-y-4">
              ...
              <div className="relative px-2">
                ...
                <button
                  ...
                  className="absolute top-1/2 right-5 -translate-y-1/2 text-slate-400 transition-colors hover:text-indigo-600"
                >
                  {showConfirmPassword ? (
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="max-h-[50vh] overflow-y-auto rounded-lg border border-slate-200 bg-slate-50 p-4">
                  <p className="font-mono text-sm break-all whitespace-pre-wrap text-slate-900">
                    {type === "key"
                      ? decryptedInfo.key
        ...
        {/* 操作按钮固定在底部 */}
        {decryptedInfo && (
          <div className="shrink-0 space-y-2 border-t border-slate-200 pt-4">
