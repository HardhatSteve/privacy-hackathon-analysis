...
export function Navbar() {
  ...
  return (
    <>
      <header className="sticky top-0 z-40 border-b border-slate-200/50 bg-white/80 shadow-sm backdrop-blur-xl transition-shadow duration-300">
        <div className="container mx-auto flex h-16 max-w-6xl items-center justify-between gap-2 px-4 sm:gap-4 lg:px-8">
          ...
          <div className="flex items-center gap-1 sm:gap-2 md:gap-3">
            ...
            {/* 分隔线（导航项和语言切换器之间） */}
            <NavDivider className="mx-1 hidden h-8 w-px bg-slate-200 lg:block" />
            ...
            {/* 分隔线（语言切换器和设置按钮之间） */}
            <NavDivider className="mx-1 hidden h-8 w-px bg-slate-200 md:block" />
