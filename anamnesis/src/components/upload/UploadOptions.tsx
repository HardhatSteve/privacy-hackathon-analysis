      ...
      >
        <div className="mt-0.5">
          <Checkbox
            ...
            disabled={!isUnlocked}
            className="h-5 w-5 border-2 data-[state=checked]:border-indigo-600 data-[state=checked]:bg-indigo-600"
          />
        </div>
      ...
      >
        <div className="mt-0.5">
          <Checkbox
            ...
            className="h-5 w-5 border-2 data-[state=checked]:border-green-600 data-[state=checked]:bg-green-600"
          />
        </div>
        <div className="flex-1">
          <Label
