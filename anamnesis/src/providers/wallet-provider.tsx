...
import { db, type DbRow } from "@/lib/sqlite-db"
import type { WalletRecord, WalletKey } from "@/lib/types"
import {
  deriveKey,
  encryptData,
  decryptData,
...
interface WalletContextType {
  ...
  activeWallet: WalletKey | null // 解密后的活跃账户对象（Arweave JWK 或其他格式的字符串）
  vaultId: string | null
  ...
  refreshWallets: () => Promise<void> // 刷新钱包列表
  getDecryptedInfo: (
    wallet: WalletRecord,
...
export function WalletProvider({ children }: { children: ReactNode }) {
  ...
  const detectChainAndAddress = async (
